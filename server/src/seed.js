...
const samplePictureBooks = [
  ...
  },
  {
    ...
    pages: [
      ...
      { pageNumber: 4, imageUrl: 'https://images.unsplash.com/photo-1557050543-4d5f4e07ef46?w=800', text: '小鼓起勇气，小心翼翼地走进水里，原来水一点也不可怕。' },
  ...
  },
  {
    ...
    author: '张明',
    illustrator: '刘芳',
    description: '小男孩潜入海底，看到了美丽的珊瑚和有趣的海洋生物。',
    coverImage: 'https://images.unsplash.com/photo-1583212292454-1fe6229603b7?w=400',
    ageRange: ['6-9'],
    theme: ['自然', '科普', '动物'],
    pages: [
      { pageNumber: 1, imageUrl: 'https://images.unsplash.com/photo-1583212292454-1fe6229603b7?w=800', text: '小宇戴着潜水镜，潜入蓝色的海底世界。' },
      { pageNumber: 2, imageUrl: 'https://images.unsplash.com/photo-1583212292454-1fe6229603b7?w=800', text: '海底有五颜六色的珊瑚，像美丽的花园。' },
      { pageNumber: 3, imageUrl: 'https://images.unsplash.com/photo-1583212292454-1fe6229603b7?w=800', text: '小鱼在珊瑚丛中穿梭，海龟悠闲地游来游去。' },
      { pageNumber: 4, imageUrl: 'https://images.unsplash.com/photo-1583212292454-1fe6229603b7?w=800', text: '小宇看到了海星、水母，还有很多叫不出名字的海洋生物。' },
      { pageNumber: 5, imageUrl: 'https://images.unsplash.com/photo-1583212292454-1fe6229603b7?w=800', text: '海底世界真奇妙，小宇想长大后要成为一名海洋生物学家。' }
    ]
  },
  {
    title: '妈妈的拥抱',
    author: '陈静',
    illustrator: '王伟',
    description: '感受妈妈温暖的拥抱，学会表达爱。',
    coverImage: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=400',
    ageRange: ['0-3', '3-6'],
    theme: ['情感'],
    pages: [
      { pageNumber: 1, imageUrl: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=800', text: '小宝宝哭了起来，妈妈温柔地把他抱在怀里。' },
      { pageNumber: 2, imageUrl: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=800', text: '妈妈的怀抱好温暖，好舒服，小宝宝慢慢不哭了。' },
      { pageNumber: 3, imageUrl: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=800', text: '妈妈亲亲小宝宝的脸，小宝宝咯咯地笑了起来。' },
      { pageNumber: 4, imageUrl: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=800', text: '小宝宝伸出小手，也要亲亲妈妈。' },
      { pageNumber: 5, imageUrl: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=800', text: '妈妈的拥抱是最好的礼物，小宝宝最爱妈妈。' }
    ]
  }
];
